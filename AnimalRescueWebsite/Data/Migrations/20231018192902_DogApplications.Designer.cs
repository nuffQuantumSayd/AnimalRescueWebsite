...
namespace AnimalRescueWebsite.Data.Migrations
{
    ...
    [Migration("20231018192902_DogApplications")]
    partial class DogApplications
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimalRescueWebsite.Models.Dog", b =>
                {
            ...
            modelBuilder.Entity("AnimalRescueWebsite.Models.DogApplicationsModel", b =>
                {
                    b.Property<int>("DogApplicationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DogApplicationId"), 1L, 1);
                    ...
                    b.HasKey("DogApplicationId");

                    b.HasIndex("Applicant");

                    b.HasIndex("Dog");

                    b.ToTable("DogApplications");
                });
            ...
            modelBuilder.Entity("AnimalRescueWebsite.Models.DogApplicationsModel", b =>
                {
                    b.HasOne("AnimalRescueWebsite.Models.Applicant", "ApplicantKey")
                        .WithMany()
                        .HasForeignKey("Applicant")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AnimalRescueWebsite.Models.Dog", "DogKey")
                        .WithMany()
                        .HasForeignKey("Dog")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ApplicantKey");
