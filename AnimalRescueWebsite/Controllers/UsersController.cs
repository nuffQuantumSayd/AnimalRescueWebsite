...
namespace AnimalRescueWebsite.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DogId,DogName,DogAge,DogSize,DogBreed,DogGender")] Dog dog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DogId,DogName,DogAge,DogSize,DogBreed,DogGender")] Dog dog)
        {
            if (id != dog.DogId)
            {
                return NotFound();
